...
//        }
    ...
    protected String combos(HttpServletRequest request, HttpServletResponse response)
        ...
        daoUsu = new DaoUsuario(con);
        daoEjemplar = new DaoEjemplar(con);

        listaUser = daoUsu.getActive();
        listEjemplar = daoEjemplar.getAll();

        //atributo con el nombre: editorial y valor: autores
        request.setAttribute("usuario", listaUser);
        request.setAttribute("ejemplar", listEjemplar);
