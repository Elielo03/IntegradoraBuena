       ...
       <!-- <a class="navbar-brand" href="IndexUsuario.jsp">LYA</a>-->
        ...
        <div class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li class="active"><a href="IndexUsuario.jsp"><span class="icon-home"></span></a></li>
                ...
                <li><a href="Ejemplar?action=consultar"><span class="icon-layers"></span>Ejemplares</a>
                   ...
                   <li><a href="Prestamo?action=consultar"><span class="icon-archive"></span>Préstamos</a>
                    <ul>
                  ...
                  <li><a href="index.jsp"><span class="icon-log-out"></span></a>
